...
//    Author:  
//    Date Modified:  
//    Brief Description: A simple implementation file for basic
//                       calculator that computes addition(+), subtraction(-),
...
if(operation=='+')
{
                  printf("Answer: %lf", number1+number2);
}
if(operation=='-')
{
                  printf("Answer: %lf", number1-number2);
...
if(operation=='%')
{
  printf("Answer: %lf", number1-floor(number1/number2)*number2);
} 
